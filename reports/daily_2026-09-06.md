# 每日 AI 调研简报 — 2026-09-06

> 生成时间：2026-09-06 01:23 UTC | 分类：`cs.AI, cs.LG, cs.CL, cs.MA` | 数据来源：GitHub Trending · arXiv

---

## 🔥 GitHub 今日热门（Top 10）

- **[sponsors/mattpocock](https://github.com/sponsors/mattpocock)** ⭐ +2692 — Skills for Real Engineers. Straight from my .agents directory.
- **[mattpocock/skills](https://github.com/mattpocock/skills)** ⭐ +1314 — The agent harness performance optimization system. Skills, instincts, memory, security, and research-first development for Claude Code, Codex, Opencode, Cursor and beyond.
- **[apps/github-actions](https://github.com/apps/github-actions)** ⭐ +2845 — Makes your AI agent think like the laziest senior dev in the room. The best code is the code you never wrote.
- **[sponsors/affaan-m](https://github.com/sponsors/affaan-m)** ⭐ +575 — The agent that grows with you
- **[affaan-m/ECC](https://github.com/affaan-m/ECC)** ⭐ +134 — A modern formatting library
- **[apps/dependabot](https://github.com/apps/dependabot)** ⭐ +475 — Public repository for Agent Skills
- **[sponsors/DietrichGebert](https://github.com/sponsors/DietrichGebert)** ⭐ +855 — 38 editorial diagram types for Claude Code, Codex, and Pi. Self-contained HTML + SVG. No shadows. No Mermaid slop.
- **[DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail)** ⭐ +725 — The open source coding agent.
- **[NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent)** ⭐ +136 — 🌊 The original agent meta-harness. Deploy intelligent multi-player swarms, coordinate autonomous workflows, and build conversational AI systems. Features adaptive memory, self-learning intelligence, RAG integration, and native Claude Code / Codex / Hermes and many more Integrated
- **[fmtlib/fmt](https://github.com/fmtlib/fmt)** ⭐ +442 — Agent skill that removes signs of AI-generated writing from text
