# 每日 AI 调研简报 — 2026-07-19

> 生成时间：2026-07-19 01:13 UTC | 分类：`cs.AI, cs.LG, cs.CL, cs.MA` | 数据来源：GitHub Trending · arXiv

---

## 🔥 GitHub 今日热门（Top 10）

- **[Robbyant/lingbot-map](https://github.com/Robbyant/lingbot-map)** ⭐ +831 — A feed-forward 3D foundation model for reconstructing scenes from streaming data
- **[apache/ossie](https://github.com/apache/ossie)** ⭐ +47 — Apache Ossie, industry wide specification effort to standardize how we exchange semantic metadata across analytics, AI and BI platforms, providing a vendor neutral, single source of truth for semantic data
- **[PostHog/posthog](https://github.com/PostHog/posthog)** ⭐ +338 — 🦔 PostHog is the leading platform for building self-driving products. Our developer tools – AI observability, analytics, session replay, flags, experiments, error tracking, logs, and more – capture all the context agents need to diagnose problems, uncover opportunities, and ship fixes. Steer it all from Slack, web, desktop, or the MCP.
- **[apps/github-actions](https://github.com/apps/github-actions)** ⭐ +123 — Skills for Design Engineers
- **[sponsors/ibelick](https://github.com/sponsors/ibelick)** ⭐ +191 — Learn it. Build it. Ship it for others.
- **[ibelick/ui-skills](https://github.com/ibelick/ui-skills)** ⭐ +355 — Local-first code intelligence graph for MCP and CLI. Builds a persistent map of your codebase so AI coding tools read only what matters, with benchmarked context reductions on reviews and large-repo workflows.
- **[sponsors/rohitg00](https://github.com/sponsors/rohitg00)** ⭐ +69 — LIBERATED AI CHAT
- **[rohitg00/ai-engineering-from-scratch](https://github.com/rohitg00/ai-engineering-from-scratch)** ⭐ +161 — AirLLM 70B inference with single 4GB GPU
- **[sponsors/tirth8205](https://github.com/sponsors/tirth8205)** ⭐ +203 — The go-to web for your AI coding agent — local-first search, fetch, crawl & research over MCP. No API keys, no cloud, $0/query. Public beta.
- **[tirth8205/code-review-graph](https://github.com/tirth8205/code-review-graph)** ⭐ +1126 — Master programming by recreating your favorite technologies from scratch.
