# 每日 AI 调研简报 — 2026-06-21

> 生成时间：2026-06-21 02:09 UTC | 分类：`cs.AI, cs.LG, cs.CL, cs.MA` | 数据来源：GitHub Trending · arXiv

---

## 🔥 GitHub 今日热门（Top 10）

- **[palmier-io/palmier-pro](https://github.com/palmier-io/palmier-pro)** ⭐ +902 — macOS video editor built for AI
- **[penpot/penpot](https://github.com/penpot/penpot)** ⭐ +420 — Penpot: The open-source design tool for design and code collaboration
- **[calesthio/OpenMontage](https://github.com/calesthio/OpenMontage)** ⭐ +677 — World's first open-source, agentic video production system. 12 pipelines, 52 tools, 500+ agent skills. Turn your AI coding assistant into a full video production studio.
- **[tursodatabase/turso](https://github.com/tursodatabase/turso)** ⭐ +801 — Turso is an in-process SQL database, compatible with SQLite.
- **[DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp)** ⭐ +1271 — High-performance code intelligence MCP server. Indexes codebases into a persistent knowledge graph — average repo in milliseconds. 158 languages, sub-ms queries, 99% fewer tokens. Single static binary, zero dependencies.
- **[apps/dependabot](https://github.com/apps/dependabot)** ⭐ +433 — TimesFM (Time Series Foundation Model) is a pretrained time-series foundation model developed by Google Research for time-series forecasting.
- **[google-research/timesfm](https://github.com/google-research/timesfm)** ⭐ +140 — The open alternative to Salesforce, designed for AI.
- **[twentyhq/twenty](https://github.com/twentyhq/twenty)** ⭐ +329 — The open-source, cross-platform API client for GraphQL, REST, WebSockets, SSE and gRPC. With Cloud, Local and Git storage.
- **[apps/github-actions](https://github.com/apps/github-actions)** ⭐ +2546 — 🤱🏻 Turn any webpage into a desktop app with one command.
- **[Kong/insomnia](https://github.com/Kong/insomnia)** ⭐ +3795 — Compress tool outputs, logs, files, and RAG chunks before they reach the LLM. 60-95% fewer tokens, same answers. Library, proxy, MCP server.
