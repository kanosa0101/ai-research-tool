# 每日 AI 调研简报 — 2026-07-11

> 生成时间：2026-07-11 01:14 UTC | 分类：`cs.AI, cs.LG, cs.CL, cs.MA` | 数据来源：GitHub Trending · arXiv

---

## 🔥 GitHub 今日热门（Top 10）

- **[sponsors/wonderwhy-er](https://github.com/sponsors/wonderwhy-er)** ⭐ +328 — This is MCP server for Claude that gives it terminal control, file system search and diff file editing capabilities
- **[wonderwhy-er/DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP)** ⭐ +209 — Incredibly fast JavaScript runtime, bundler, test runner, and package manager – all in one
- **[oven-sh/bun](https://github.com/oven-sh/bun)** ⭐ +89 — Abseil Common Libraries (C++)
- **[apps/autofix-ci](https://github.com/apps/autofix-ci)** ⭐ +1116 — Production-grade engineering skills for AI coding agents.
- **[abseil/abseil-cpp](https://github.com/abseil/abseil-cpp)** ⭐ +69 — A YAML parser and emitter in C++
- **[addyosmani/agent-skills](https://github.com/addyosmani/agent-skills)** ⭐ +1712 — Skills for Real Engineers. Straight from my .claude directory.
- **[jbeder/yaml-cpp](https://github.com/jbeder/yaml-cpp)** ⭐ +1013 — An agentic skills framework & software development methodology that works.
- **[sponsors/mattpocock](https://github.com/sponsors/mattpocock)** ⭐ +177 — TypeScript is a superset of JavaScript that compiles to clean JavaScript output.
- **[mattpocock/skills](https://github.com/mattpocock/skills)** ⭐ +76 — A modern, C++-native, test framework for unit-tests, TDD and BDD - using C++14, C++17 and later (C++11 support is in v2.x branch, and C++03 on the Catch1.x branch)
- **[apps/github-actions](https://github.com/apps/github-actions)** ⭐ +92 — Asio C++ Library
