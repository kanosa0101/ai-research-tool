# 每日 AI 调研简报 — 2026-06-13

> 生成时间：2026-06-13 01:57 UTC | 分类：`cs.AI, cs.LG, cs.CL, cs.MA` | 数据来源：GitHub Trending · arXiv

---

## 🔥 GitHub 今日热门（Top 10）

- **[addyosmani/agent-skills](https://github.com/addyosmani/agent-skills)** ⭐ +2656 — Production-grade engineering skills for AI coding agents.
- **[sponsors/music-assistant](https://github.com/sponsors/music-assistant)** ⭐ +20 — Music Assistant is a free, opensource Media library manager that connects to your streaming services and a wide range of connected speakers. The server is the beating heart, the core of Music Assistant and must run on an always-on device like a Raspberry Pi, a NAS or an Intel NUC or alike.
- **[music-assistant/server](https://github.com/music-assistant/server)** ⭐ +388 — Mattermost is an open source platform for secure collaboration across the entire software development lifecycle..
- **[apps/dependabot](https://github.com/apps/dependabot)** ⭐ +3504 — A tool for creating and running Linux containers using lightweight virtual machines on a Mac. It is written in Swift, and optimized for Apple silicon.
- **[mattermost/mattermost](https://github.com/mattermost/mattermost)** ⭐ +179 — Collection of publicly available IPTV channels from all over the world
- **[apple/container](https://github.com/apple/container)** ⭐ +1275 — An agentic skills framework & software development methodology that works.
- **[iptv-org/iptv](https://github.com/iptv-org/iptv)** ⭐ +369 — Desktop app to manage markdown knowledge bases
- **[apps/iptv-bot](https://github.com/apps/iptv-bot)** ⭐ +515 — open-source healthcare ai
- **[sponsors/obra](https://github.com/sponsors/obra)** ⭐ +28 — LMCache: Supercharge Your LLM with the Fastest KV Cache Layer
- **[obra/superpowers](https://github.com/obra/superpowers)** ⭐ +827 — PM Skills Marketplace: 100+ agentic skills, commands, and plugins — from discovery to strategy, execution, launch, and growth.
