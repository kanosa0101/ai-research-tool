# 每日 AI 调研简报 — 2026-08-01

> 生成时间：2026-08-01 01:21 UTC | 分类：`cs.AI, cs.LG, cs.CL, cs.MA` | 数据来源：GitHub Trending · arXiv

---

## 🔥 GitHub 今日热门（Top 10）

- **[zhaoxuya520/reverse-skill](https://github.com/zhaoxuya520/reverse-skill)** ⭐ +335 — Reverse Engineering / Authorized Penetration Testing / Security Research Skill Router Pack AI-powered routing + On-demand toolchain bootstrapping + Self-evolving knowledge base Supports Claude Code, Kiro, Cursor, Cline, and other AI coding clients 逆向/渗透/安全技能路由包 - AI 自动路由 + 按需自举工具链 + 自动进化经验库 | 支持 Claude Code / Kiro / Cursor / Cline 等代码 AI 客户端
- **[different-ai/openwork](https://github.com/different-ai/openwork)** ⭐ +806 — The open-source alternative to Claude Cowork (powered by opencode)
- **[mvanhorn/last30days-skill](https://github.com/mvanhorn/last30days-skill)** ⭐ +658 — AI agent skill that researches any topic across Reddit, X, YouTube, HN, Polymarket, and the web - then synthesizes a grounded summary
- **[paperswithbacktest/awesome-systematic-trading](https://github.com/paperswithbacktest/awesome-systematic-trading)** ⭐ +763 — A curated list of awesome libraries, packages, strategies, books, blogs, tutorials for systematic trading.
- **[microsoft/AI-For-Beginners](https://github.com/microsoft/AI-For-Beginners)** ⭐ +1592 — 12 Weeks, 24 Lessons, AI for All!
- **[github/copilot-sdk](https://github.com/github/copilot-sdk)** ⭐ +7 — Multi-platform SDK for integrating GitHub Copilot Agent into apps and services
- **[apps/github-copilot-cli](https://github.com/apps/github-copilot-cli)** ⭐ +35 — Open-source live-chat, email support, omni-channel desk. An alternative to Intercom, Zendesk, Salesforce Service Cloud etc. 🔥💬
- **[apps/github-actions](https://github.com/apps/github-actions)** ⭐ +335 — a code review TUI with vim keybindings
- **[sponsors/chatwoot](https://github.com/sponsors/chatwoot)** ⭐ +194 — 🎯 All you need. Nothing you don't. Open source project management that works for you, not against you.
- **[chatwoot/chatwoot](https://github.com/chatwoot/chatwoot)** ⭐ +83 — A Hardware Hacking Tool with Web-Based CLI That Speaks Every Protocol
