# 每日 AI 调研简报 — 2026-08-09

> 生成时间：2026-08-09 00:38 UTC | 分类：`cs.AI, cs.LG, cs.CL, cs.MA` | 数据来源：GitHub Trending · arXiv

---

## 🔥 GitHub 今日热门（Top 10）

- **[PrimeIntellect-ai/prime-agent](https://github.com/PrimeIntellect-ai/prime-agent)** ⭐ +2483 — A self-improving RLM agent for coding workflows and long-running autonomous tasks.
- **[addyosmani/agent-skills](https://github.com/addyosmani/agent-skills)** ⭐ +779 — Production-grade engineering skills for AI coding agents.
- **[TapXWorld/ChinaTextbook](https://github.com/TapXWorld/ChinaTextbook)** ⭐ +118 — 所有小初高、大学PDF教材。
- **[google/skills](https://github.com/google/skills)** ⭐ +481 — Agent Skills for Google products and technologies
- **[sponsors/mattpocock](https://github.com/sponsors/mattpocock)** ⭐ +1359 — Skills for Real Engineers. Straight from my .agents directory.
- **[mattpocock/skills](https://github.com/mattpocock/skills)** ⭐ +467 — The authentication glue you need.
- **[apps/github-actions](https://github.com/apps/github-actions)** ⭐ +153 — TradingAgents: Multi-Agents LLM Financial Trading Framework
- **[sponsors/goauthentik](https://github.com/sponsors/goauthentik)** ⭐ +93 — Google core libraries for Java
- **[goauthentik/authentik](https://github.com/goauthentik/authentik)** ⭐ +48 — Truly independent web browser
- **[apps/dependabot](https://github.com/apps/dependabot)** ⭐ +432 — self-hosted, distributed Durable Objects
