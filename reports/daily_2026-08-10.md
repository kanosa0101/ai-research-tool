# 每日 AI 调研简报 — 2026-08-10

> 生成时间：2026-08-10 00:40 UTC | 分类：`cs.AI, cs.LG, cs.CL, cs.MA` | 数据来源：GitHub Trending · arXiv

---

## 🔥 GitHub 今日热门（Top 10）

- **[PrimeIntellect-ai/prime-agent](https://github.com/PrimeIntellect-ai/prime-agent)** ⭐ +2356 — A self-improving RLM agent for coding workflows and long-running autonomous tasks.
- **[sponsors/vitali87](https://github.com/sponsors/vitali87)** ⭐ +96 — The ultimate RAG for your monorepo. Query, understand, and edit multi-language codebases with the power of AI and knowledge graphs
- **[vitali87/code-graph-rag](https://github.com/vitali87/code-graph-rag)** ⭐ +858 — A complete AI agency at your fingertips - From frontend wizards to Reddit community ninjas, from whimsy injectors to reality checkers. Each agent is a specialized expert with personality, processes, and proven deliverables.
- **[apps/github-actions](https://github.com/apps/github-actions)** ⭐ +210 — Why is this running? Trace any process, port, container, or file back to what started it - CLI + TUI.
- **[apps/dependabot](https://github.com/apps/dependabot)** ⭐ +86 — Production-grade engineering skills for AI coding agents.
- **[sponsors/msitarzewski](https://github.com/sponsors/msitarzewski)** ⭐ +680 — LLM 驱动的多市场股票智能分析系统：多源行情、实时新闻、决策看板与自动推送，支持零成本定时运行。 LLM-powered multi-market stock analysis system with multi-source market data, real-time news, decision dashboard, automated notifications, and cost-free scheduled runs.
- **[msitarzewski/agency-agents](https://github.com/msitarzewski/agency-agents)** ⭐ +306 — The authentication glue you need.
- **[sponsors/pranshuparmar](https://github.com/sponsors/pranshuparmar)** ⭐ +310 — Agent Skills for Google products and technologies
- **[pranshuparmar/witr](https://github.com/pranshuparmar/witr)** ⭐ +528 — The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface.
- **[google-deepmind/weathernext](https://github.com/google-deepmind/weathernext)** ⭐ +365 — A benchmark built to evaluate and improve agent capabilities for supporting legal work.
