# 每日 AI 调研简报 — 2026-07-06

> 生成时间：2026-07-06 01:30 UTC | 分类：`cs.AI, cs.LG, cs.CL, cs.MA` | 数据来源：GitHub Trending · arXiv

---

## 🔥 GitHub 今日热门（Top 10）

- **[sponsors/Zackriya-Solutions](https://github.com/sponsors/Zackriya-Solutions)** ⭐ +1409 — Privacy first, AI meeting assistant with 4x faster Parakeet/Whisper live transcription, speaker diarization, and Ollama summarization built on Rust. 100% local processing. no cloud required. Meetily (Meetly Ai - <a href="https://meetily.ai" class="Link--inTextBlock" rel="nofollow">https://meetily.ai</a>) is the #1 Self-hosted, Open-source Ai meeting note taker for macOS & Windows.
- **[Zackriya-Solutions/meetily](https://github.com/Zackriya-Solutions/meetily)** ⭐ +1532 — Use Codex from Claude Code to review code or delegate tasks.
- **[openai/codex-plugin-cc](https://github.com/openai/codex-plugin-cc)** ⭐ +981 — Extracted system prompts from Anthropic - Claude Fable 5, Opus 4.8, Claude Code, Claude Design. OpenAI - ChatGPT 5.5 Thinking, GPT 5.5 Instant, Codex. Google - Gemini 3.5 Flash, 3.1 Pro, Antigravity. xAI - Grok, Cursor, Copilot, VS Code, Perplexity, and more. Updated regularly.
- **[sponsors/asgeirtj](https://github.com/sponsors/asgeirtj)** ⭐ +863 — Taste-Skill - gives your AI good taste. stops the AI from generating boring, generic slop
- **[asgeirtj/system_prompts_leaks](https://github.com/asgeirtj/system_prompts_leaks)** ⭐ +392 — 337 Claude Code skills & agent skills & plugins (30+ Agents, 70+ custom commands, 330+ skills, customizable references, scripts)for Claude Code, Codex, Gemini CLI, Cursor, and 8 more coding agents — engineering, marketing, product, compliance, C-level advisory, research, business operations, commercial & finance, and your daily productivity skills.
- **[sponsors/Leonxlnx](https://github.com/sponsors/Leonxlnx)** ⭐ +410 — A beautiful, powerful, self-hosted rom manager and player.
- **[Leonxlnx/taste-skill](https://github.com/Leonxlnx/taste-skill)** ⭐ +651 — agent multiplexer that lives in your terminal.
- **[alirezarezvani/claude-skills](https://github.com/alirezarezvani/claude-skills)** ⭐ +805 — JavaScript in-page GUI agent. Control web interfaces with natural language.
- **[rommapp/romm](https://github.com/rommapp/romm)** ⭐ +329 — Machine Learning Systems
- **[apps/dependabot](https://github.com/apps/dependabot)** ⭐ +1114 — Open-source AI penetration testing tool to find and fix your app’s vulnerabilities.
